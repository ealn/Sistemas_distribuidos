...
public class GUIServer implements Constants
{
    ...
    private void initialize() 
    {
        ...
        textAreaClientList.setBounds(10, 75, 272, 175);
        frmTcpServer.getContentPane().add(textAreaClientList);
        ...
        textAreaMessReceived.setBounds(10, 286, 272, 253);
    ...
    private static int init()
    {
        ...
        ret = Connections.initConnection(port);
